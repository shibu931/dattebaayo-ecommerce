                ...
                <div class="container text-center col-md-4 mb-5">
                    ...
                    <form action="/generateOtp" method="get">
                        <div class="form-group">
                            <input type="number" id="number-input" class="form-control py-4" placeholder="Enter Your Phone Number" required="required" name="number" />
                        </div>
                        <%
                        ...
                        <%} %>
                        <div>
                            <button class="btn btn-primary btn-block border-0 py-3" type="submit">Proceed</button>
                        </div>
                    </form>
                </div>
			</div>
