                ...
                <div class="container text-center col-md-4 mb-5">
                    ...
                    <form action="/changePass" method="POSt">
                        <div class="form-group">
                            <input type="password" id="number-input" class="form-control py-4" placeholder="Enter Your Password" required="required" name="password" />
                        </div>
                        <div class="form-group">
                            <input type="password" id="number-input" class="form-control py-4" placeholder="Re-Enter Your Password" required="required" name="repass" />
                        </div>
                        <%
